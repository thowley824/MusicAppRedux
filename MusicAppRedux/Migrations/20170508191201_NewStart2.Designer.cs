...
namespace MusicAppRedux.Migrations
{
    ...
    [Migration("20170508191201_NewStart2")]
    partial class NewStart2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MusicAppRedux.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("UserFavoriteGenreID");
            ...
            modelBuilder.Entity("MusicAppRedux.Models.Rate", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MusicAppRedux.Models.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MusicAppRedux.Models.Rate", b =>
                {
                    b.HasOne("MusicAppRedux.Models.Album", "album")
                        .WithMany()
